  ...
  return (
    <form>
      ...
      <Select defaultValue="" onChange={handleChange} displayEmpty>
        ...
        <MenuItem value="스터디룸1">스터디룸1</MenuItem>
        <MenuItem value="스터디룸2">스터디룸2</MenuItem>
        <MenuItem value="스터디룸3">스터디룸3</MenuItem>
        <MenuItem value="스터디룸4">스터디룸4</MenuItem>
        <MenuItem value="스터디룸5">스터디룸5</MenuItem>
      </Select>
    </form>
  );
}
