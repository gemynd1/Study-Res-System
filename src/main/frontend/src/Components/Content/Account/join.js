        ...
        >
          <Box sx={style}>
            <div className="modal-join-header">
              <span className="modal-join-header-title">
                {selectedItem.propTitle}
              </span>
            </div>
            <div className="modal-join-title-section">
              {selectedItem.content.map((contentitem, index) => (
                <div key={index}>
                  <span className="modal-join-title">
                    {contentitem.subTitle}
                  </span>
                  <br />
                  <span className="modal-join-content">
            ...
            <form className="form-content" onSubmit={onSubmit}>
              ...
              <div className="addInput">
                ...
                <input
                  type="hidden"
                  name="latitude"
                  value={enroll_company.latitude}
                />
                <input
                  type="hidden"
                  name="longitude"
                  value={enroll_company.longitude}
                />
              </div>
