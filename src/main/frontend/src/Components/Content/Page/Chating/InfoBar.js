    ...
    return (
        <div className='infoBar'>
            ...
            <div className="chatClose">
                <img src="/img/icon/arrowDown(white).png" alt="토글내리기" style={{width: "24px", height: "24px", marginLeft: "230px"}}
                     onClick={(e) => {
                         e.preventDefault();
                         onToggle();
                     }}/>

                <img src="/img/icon/close(white).png" style={{width: "20px", height: "20px", marginLeft: "15px"}}
